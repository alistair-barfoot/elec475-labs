...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{imgs/training_history.png}
\end{figure}
\newpage

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.75\textwidth]{imgs/warmstart__kd_training_history_feature_based__feature.png}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.75\textwidth]{imgs/warmstart__kd_training_history_response_based__response.png}
\end{figure}
...
After fixing the Initial logits the mIoU improved to 42\% after 47 epochs. The model not only worked as intended it worked very well for a model with around 1 million parameters.\\
\\
...
\begin{table}[h]
  ...
  \begin{tabular}{|c|c|c|c|}
    \hline
    \textbf{Knowledge Distillation} & \textbf{mIoU} & \textbf{\# Parameters} & \textbf{Inference Speed (ms/sample)} \\
    \hline
